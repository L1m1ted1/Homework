...
let squareRectangle = (a,b) => console.log(a * b)
squareRectangle(3,4)

// - створити функцію яка обчислює та повертає площу кола з радіусом r
let circleSquare = (r)=> console.log(r * r * Math.PI)
circleSquare(4)

// - створити функцію яка обчислює та повертає площу циліндру висотою h, та радіутом r
let cylinderSquare = (r,h) => console.log(2 * r * Math.PI * (h + r))
cylinderSquare(6,7)
